...
SECRET_KEY = 'django-insecure-(mt01%-0xww&(oh9!pt&m_mg==dcu_+nx19hju@$txkpata!20'
...
BOOTSTRAP4 = {
    'settings': {
        'BASE_URL': '//maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/css',
        'NAVBAR_MENU_IN_COLLAPSE': True,
        'INCLUDE_JQUERY': True,
    },
}
